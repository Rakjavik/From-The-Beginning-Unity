    ...
    public class LimbHackerAgent : MonoBehaviour
    {
        ...
        void ConsumeJobYield(JobState jobState)
        {
            ...
            else
            {
                ...
                alfaObject.GetComponent<CritterAgent>().lastSevered = jobSpecification.Subject.GetComponent<CritterAgent>().consumeLastSevered();

                alfaObject.name = string.Format("{0} (Alfa)", alfaObject.GetComponent<CritterAgent>().lastSevered.getName());
